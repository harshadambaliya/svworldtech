...
( function($){
	...
	kc.detect = {
		...
		click : function( e ){
			...
			if (kc.detect.disabled !== true && kc.detect.css_inspector.enable !== true) {	
		...
		elements_tree : function( ob ){
			...
			var kib = $('<div id="kc-elms-breadcrumn"><ul></ul></div>'),
				acts = {
					...
					insert: ['fa-sticky-note', kc.__.aiL10n.insertColumn+
							'\
					...
					addin: ['fa-list-alt', kc.__.aiL10n.addElement+'\
					...
					addto: ['fa-list-alt', kc.__.aiL10n.addElement+'\
					...
					'new-row': ['fa-plus-square', kc.__.aiL10n.insertRow+
								'<span data-act="insert-row" data-dir="before">\
									'+kc.__.before+'\
								</span>\
					...
					'move-column': ['fa-exchange', kc.__.aiL10n.moveColumns+
								'<span data-act="move-column" data-dir="left">\
			...
			*/
			...
			while (ob !== null)
			{
				...
				words = ob[2].replace(/kc\_/g,'').split('_');
				ob[4] = words[0];
				for (var i = 1; i < words.length; i++) {
					ob[4] = ob[4] + words[i][0].toUpperCase()+words[i].slice(1);
				}
					...
					*/
					...
					if (['kc_column', 'kc_column_inner'].indexOf (ob[2]) === -1 && li === ''){
						li = '<li class="item for-responsive active" data-holder="column" data-e-model="'+ob[1]+'" data-e-name="'+ob[2]+'"> \
								<span class="pointer"><i class="fa-angle-right"></i> '+kc.__.aiL10n[ob[4]]+'</span> \
								<ul> \
									<li data-act="edit" data-name="'+ob[2]+'"> \
										<i class="fa-pencil"></i> '+kc.__.edit+' \
									</li> \
									<li data-act="clear-style" data-name="'+ob[2]+'"> \
										<i class="fa-eraser"></i> '+kc.__.aiL10n.clearScreenStyle+' \
									</li> \
								</ul> \
							</li>';
					}
					else if (['kc_column', 'kc_column_inner'].indexOf (ob[2]) > -1)
					{
						...
						li += '<li class="item for-responsive" data-holder="column" data-e-model="'+ob[1]+'" data-e-name="'+ob[2]+'"> \
								<span class="pointer" data-act="edit" data-name="'+ob[2]+'">\
									<i class="fa-angle-right"></i> '+kc.__.aiL10n[ob[4]]+
								'</span> \
								<ul> \
									<li data-act="edit" data-name="'+ob[2]+'"> \
										<i class="fa-pencil"></i> '+kc.__.edit+' \
									...
									<li data-act="responsive" data-width="100%" data-offset="0%"> \
										<i class="fa-star"></i> 100% '+kc.__.aiL10n.offset+' 0% \
									</li> \
									<li data-act="responsive" data-width="90%" data-offset="5%"> \
										<i class="fa-leaf"></i> 90% '+kc.__.aiL10n.offset+' 5% \
									</li> \
									<li data-act="responsive" data-width="80%" data-offset="10%"> \
										<i class="fa-paper-plane"></i> 80% '+kc.__.aiL10n.offset+' 10% \
									</li> \
									<li data-act="responsive" data-width="50%" data-offset="0%"> \
										<i class="fa-star-half-empty"></i> 50% '+kc.__.aiL10n.offset+' 0% \
									</li> \
									<li> \
										<i class="fa-paw"></i> '+kc.__.aiL10n.custom+':<br /> \
										<input data-act="custom-width" placeholder="'+kc.__.aiL10n.width+'" /> \
										<input data-act="custom-offset" placeholder="'+kc.__.aiL10n.offset+'" /> \
									</li> \
									<li data-act="clear-style" data-name="'+ob[2]+'"> \
										<i class="fa-eraser"></i> '+kc.__.aiL10n.clearScreenStyle+' \
									</li> \
		...
		column : function( el, index, hit ){
			...
			if( this.rect( [ el, el.getAttribute( 'data-model' ) ], this.holder.columns[ index ], 0 ) !== false ){
				...
				if( st !== undefined && st.name == 'kc_column_inner' ){
					...
					this.holder.columns[ index ].main.find('li.row-control>label').html(kc.__.aiL10n.rowInner);
				}else{
					this.holder.columns[ index ].main.removeClass('mpb-column-inner');
					this.holder.columns[ index ].main.find('li.row-control>label').html(kc.__.aiL10n.row);
				}
