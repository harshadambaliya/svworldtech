...
<div id="kc-element-placeholder" class="kc-boxholder">
	<div class="mpb-tooltip move tip cxols">
		...
		<span class="tips">
			<ol>
				<li class="short">
					<i class="fa-recycle" title="<?php _e( 'Delete', 'kingcomposer' ); ?>" data-action="delete"></i>
					<i class="fa-copy" title="<?php _e( 'Copy', 'kingcomposer' ); ?>" data-action="copy"></i>
					<i class="fa-clone" title="<?php _e( 'Double', 'kingcomposer' ); ?>" data-action="double"></i>
					<i class="fa-edit" title="<?php _e( 'Edit', 'kingcomposer' ); ?>" data-action="edit"></i>
				</li>
			</ol>
		</span>
	</div>
